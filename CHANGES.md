...
## [4.1.0]
- [TASK] Add Upgrade wizard to migrate old plugins with list_type to CType

## [4.0.0]
- [IMPORTANT] LIVE Switch upgrade-v14

## [upgrade-v14-1]
- [TASK] Use prefix: q_ as workaround for string values for array keys on selectedAnswers
